...
const PaymentCashScreen = ({ onNavigate, token, pedido, metodo, onPagoRegistrado }) => {
  ...
  const handleConfirmar = async () => {
    ...
    setProcesando(true);
    try {
      const pago = await registrarPago(token, pedido.id, metodo.id, recibido);
    ...
    >
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          ...
          disabled={!recibidoValido || procesando}
