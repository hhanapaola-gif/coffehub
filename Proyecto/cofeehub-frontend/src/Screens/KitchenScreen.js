...
// pedidos de ejemplo, no vienen de ningun backend
const PEDIDOS_DEMO = [
  {
    id: 1, folio: '1458', id_mesa: 5, estatus: 'pendiente',
    fecha_hora: new Date(Date.now() - 5 * 60000).toISOString(),
    detalles: [
      { id: 1, nombre_producto: 'Cappuccino', cantidad: 2 },
      { id: 2, nombre_producto: 'Croissant de Mantequilla', cantidad: 1 },
    ],
  },
  {
    id: 2, folio: '1461', id_mesa: 2, estatus: 'en_preparacion',
    fecha_hora: new Date(Date.now() - 9 * 60000).toISOString(),
    detalles: [{ id: 3, nombre_producto: 'Sándwich Club', cantidad: 2 }],
  },
  {
    id: 3, folio: '1463', id_mesa: 1, estatus: 'pendiente',
    fecha_hora: new Date(Date.now() - 2 * 60000).toISOString(),
    detalles: [
      { id: 4, nombre_producto: 'Latte Vainilla', cantidad: 1 },
      { id: 5, nombre_producto: 'Pastel de Chocolate', cantidad: 1 },
    ],
  },
];

const KitchenScreen = ({ onNavigate, onOpenMenu, role }) => {
